...
export interface VelodromePairInterface extends utils.Interface {
  functions: {
...
export interface VelodromePair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VelodromePairInterface;
  ...
  functions: {
    ...
    lastObservation(
      overrides?: CallOverrides
    ): Promise<[Pair.ObservationStructOutput]>;
